...
class SkipGramModel:
    ...
    def _create_optimizer(self):
        ...
        self.optimizer = tf.compat.v1.train.GradientDescentOptimizer(self.lr).minimize(self.loss,
    ...
    def train(self, num_train_steps):
        saver = tf.compat.v1.train.Saver()  # defaults to saving all variables - in this case embed_matrix, nce_weight, nce_bias
        ...
        with tf.compat.v1.Session() as sess:
            ...
            writer = tf.summary.FileWriter('data/graphs/word2vec/lr' + str(self.lr), sess.graph)
